...
#include "Trace.h"
#include "../../shared/VDisplayShared.h"
...
namespace Microsoft
{
    namespace IndirectDisp
    {
        ...
        struct IndirectSampleMonitor
        {
            ...
            static constexpr size_t szModeList = 5;
        ...
        private:
            ...
            void RenderSharedFrame(ID3D11Texture2D* pTarget);
            ...
            HANDLE m_hLayoutMap;
            HANDLE m_hFramesMap;
            VDisplaySharedLayout* m_pLayout;
            VDisplaySharedFrames* m_pFrames;
